...
def trainingwork(settings):
    ...
    from src.segmentation_network_main_script import training_models
    from src.segmentation_network_build_model import build_and_compile_models
...
if __name__ == '__main__':
    ...
    try:
        ...
        print('')
        print('')
        print('\x1b[6;30;42m' + 'trainind started.......................' + '\x1b[0m')
        settings = read_default_config()
        trainingwork(settings)
        print('\x1b[6;30;42m' + 'trainind completed.....................' + '\x1b[0m')
