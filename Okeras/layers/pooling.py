...
class _Pooling1D(Layer):
    ...
    def read_default_config(self):
        config = {'strides': self.strides,
                  ...
                  'padding': self.padding}
        base_config = super(_Pooling1D, self).read_default_config()
...
class _Pooling2D(Layer):
    ...
    def read_default_config(self):
        config = {'pool_size': self.pool_size,
                  ...
                  'strides': self.strides,
                  'data_format': self.data_format}
        base_config = super(_Pooling2D, self).read_default_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class _Pooling3D(Layer):
    ...
    def read_default_config(self):
        config = {'pool_size': self.pool_size,
                  ...
                  'strides': self.strides,
                  'data_format': self.data_format}
        base_config = super(_Pooling3D, self).read_default_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class _GlobalPooling2D(Layer):
    ...
    def read_default_config(self):
        ...
        base_config = super(_GlobalPooling2D, self).read_default_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class _GlobalPooling3D(Layer):
    ...
    def read_default_config(self):
        config = {'data_format': self.data_format}
        base_config = super(_GlobalPooling3D, self).read_default_config()
        return dict(list(base_config.items()) + list(config.items()))
