...
class Masking(Layer):
    ...
    def read_default_config(self):
        ...
        base_config = super(Masking, self).read_default_config()
...
class Dropout(Layer):
    ...
    def read_default_config(self):
        ...
        base_config = super(Dropout, self).read_default_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class Activation(Layer):
    ...
    def read_default_config(self):
        ...
        base_config = super(Activation, self).read_default_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class Reshape(Layer):
    ...
    def read_default_config(self):
        ...
        base_config = super(Reshape, self).read_default_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class Permute(Layer):
    ...
    def read_default_config(self):
        ...
        base_config = super(Permute, self).read_default_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class RepeatVector(Layer):
    ...
    def read_default_config(self):
        config = {'n': self.n}
        base_config = super(RepeatVector, self).read_default_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class Lambda(Layer):
    ...
    def read_default_config(self):
        ...
        config = {'function': function,
                  ...
                  'arguments': self.arguments}
        base_config = super(Lambda, self).read_default_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class Dense(Layer):
    ...
    def read_default_config(self):
        ...
        base_config = super(Dense, self).read_default_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class ActivityRegularization(Layer):
    ...
    def read_default_config(self):
        config = {'l1': self.l1,
                  'l2': self.l2}
        base_config = super(ActivityRegularization, self).read_default_config()
        return dict(list(base_config.items()) + list(config.items()))
