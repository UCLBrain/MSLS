...
class _Conv(Layer):
    ...
    def read_default_config(self):
        ...
        base_config = super(_Conv, self).read_default_config()
...
class Conv1D(_Conv):
    ...
    def read_default_config(self):
        config = super(Conv1D, self).read_default_config()
        config.pop('rank')
...
class Conv2D(_Conv):
    ...
    def read_default_config(self):
        config = super(Conv2D, self).read_default_config()
        config.pop('rank')
        return config
...
class Conv3D(_Conv):
    ...
    def read_default_config(self):
        config = super(Conv3D, self).read_default_config()
        config.pop('rank')
        return config
...
class Conv2DTranspose(Conv2D):
    ...
    def read_default_config(self):
        config = super(Conv2DTranspose, self).read_default_config()
...
class SeparableConv2D(Conv2D):
    ...
    def read_default_config(self):
        config = super(SeparableConv2D, self).read_default_config()
...
class UpSampling1D(Layer):
    ...
    def read_default_config(self):
        ...
        base_config = super(UpSampling1D, self).read_default_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class UpSampling2D(Layer):
    ...
    def read_default_config(self):
        config = {'size': self.size,
                  'data_format': self.data_format}
        base_config = super(UpSampling2D, self).read_default_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class UpSampling3D(Layer):
    ...
    def read_default_config(self):
        config = {'size': self.size,
                  'data_format': self.data_format}
        base_config = super(UpSampling3D, self).read_default_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class ZeroPadding1D(Layer):
    ...
    def read_default_config(self):
        ...
        base_config = super(ZeroPadding1D, self).read_default_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class ZeroPadding2D(Layer):
    ...
    def read_default_config(self):
        config = {'padding': self.padding,
                  'data_format': self.data_format}
        base_config = super(ZeroPadding2D, self).read_default_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class ZeroPadding3D(Layer):
    ...
    def read_default_config(self):
        config = {'padding': self.padding,
                  'data_format': self.data_format}
        base_config = super(ZeroPadding3D, self).read_default_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class Cropping1D(Layer):
    ...
    def read_default_config(self):
        ...
        base_config = super(Cropping1D, self).read_default_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class Cropping2D(Layer):
    ...
    def read_default_config(self):
        config = {'cropping': self.cropping,
                  'data_format': self.data_format}
        base_config = super(Cropping2D, self).read_default_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class Cropping3D(Layer):
    ...
    def read_default_config(self):
        config = {'cropping': self.cropping,
                  'data_format': self.data_format}
        base_config = super(Cropping3D, self).read_default_config()
        return dict(list(base_config.items()) + list(config.items()))
