...
def count_params(layer, **tags):
    ...
    **tags (optional)
    ...
    >>> l_in = InputLayer((100, 20))
    >>> l1 = DenseLayer(l_in, num_units=50)
    >>> setting_count = count_params(l1)
    >>> setting_count
    1050
    >>> setting_count == 20 * 50 + 50  # 20 input * 50 units + 50 biases
    True
    """
...
def get_all_setting_values(layer, **tags):
    """
    ...
    This function can be used in conjunction with set_all_setting_values to save
    ...
    **tags (optional)
    ...
    >>> l_in = InputLayer((100, 20))
    >>> l1 = DenseLayer(l_in, num_units=50)
    >>> all_setting_values = get_all_setting_values(l1)
    >>> (all_setting_values[0] == l1.W.get_value()).all()
    True
    >>> (all_setting_values[1] == l1.b.get_value()).all()
    True
    """
    params = get_all_params(layer, **tags)
...
def set_all_setting_values(layer, values, **tags):
    """
    ...
    This function can be used in conjunction with get_all_setting_values to save
    and restore model parameters.
    ...
    **tags (optional)
    ...
    >>> l1 = DenseLayer(l_in, num_units=50)
    >>> all_setting_values = get_all_setting_values(l1)
    >>> # all_setting_values is now [l1.W.get_value(), l1.b.get_value()]
    >>> # ...
    >>> set_all_setting_values(l1, all_setting_values)
