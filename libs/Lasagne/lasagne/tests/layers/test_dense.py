...
class TestDenseLayer:
    ...
    def test_get_params(self, layer):
        ...
        assert layer.get_params(_nonexistent_mod=True) == []
        assert layer.get_params(_nonexistent_mod=False) == [layer.W, layer.b]
    ...
    def test_setting_names(self, layer):
        assert layer.W.name == "W"
        assert layer.b.name == "b"

    def test_named_layer_setting_names(self, DenseLayer, dummy_input_layer):
        layer = DenseLayer(
            dummy_input_layer,
            num_units=3,
            name="foo"
...
class TestNINLayer:
    ...
    def test_named_layer_setting_names(self, NINLayer, dummy_input_layer):
        layer = NINLayer(
            dummy_input_layer,
            num_units=3,
            name="foo"
