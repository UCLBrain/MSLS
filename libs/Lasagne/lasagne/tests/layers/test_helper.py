...
class TestGetAllParamValues:
    def test_get_all_setting_values(self):
        ...
        pvs = get_all_setting_values(l3)
        assert len(pvs) == 4


class TestSetAllParamValues:
    def test_set_all_setting_values(self):
        from lasagne.layers import (InputLayer, DenseLayer,
        ...
        set_all_setting_values(l3, [a2, b2, a3, b3])
        ...
        with pytest.raises(ValueError):
            set_all_setting_values(l3, [a3, b3, a2])

        with pytest.raises(ValueError):
            a3_bad = floatX(numpy.random.normal(0, 1, (25, 40)))
            set_all_setting_values(l3, [a2, b2, a3_bad, b3])
