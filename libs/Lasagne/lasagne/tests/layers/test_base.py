...
class TestLayer:
    ...
    def test_get_params_mods(self, layer):
        a_shape = (20, 50)
    ...
    def test_add_setting_mods(self, layer):
        a_shape = (20, 50)
        a = numpy.random.normal(0, 1, a_shape)
    ...
    def test_add_setting_name(self, layer):
        a_shape = (20, 50)
        a = numpy.random.normal(0, 1, a_shape)
        A = layer.add_param(a, a_shape, name='A')
        assert A.name == 'A'

    def test_add_setting_named_layer_name(self, named_layer):
        a_shape = (20, 50)
        a = numpy.random.normal(0, 1, a_shape)
