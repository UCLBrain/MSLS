...
def test_create_setting_bad_callable_raises():
...
def test_create_setting_bad_spec_raises():
    from lasagne.utils import create_param
...
def test_create_setting_accepts_iterable_shape():
    from lasagne.utils import create_param
    factory = np.empty
...
def test_create_setting_numpy_bad_shape_raises_error():
    from lasagne.utils import create_param
...
def test_create_setting_numpy_returns_shared():
    from lasagne.utils import create_param
...
def test_create_setting_number_returns_same():
    from lasagne.utils import create_param
...
def test_create_setting_numpy_generic_returns_same():
    from lasagne.utils import create_param
...
def test_create_setting_shared_returns_same():
    from lasagne.utils import create_param
...
def test_create_setting_shared_bad_ndim_raises_error():
    from lasagne.utils import create_param
...
def test_create_setting_callable_returns_return_value():
    from lasagne.utils import create_param
...
def test_create_setting_callable_returns_shared():
    from lasagne.utils import create_param
...
def test_create_setting_callable_returns_shared_bad_ndim_raises_error():
    from lasagne.utils import create_param
...
def test_create_setting_callable_returns_theano_expr():
    from lasagne.utils import create_param
...
def test_create_setting_callable_returns_wrong_type():
    from lasagne.utils import create_param
...
def test_create_setting_retain_ndarray_dtype():
    from lasagne.utils import create_param
    param = np.array([[1, 2, 3], [4, 5, 6]])
...
def test_create_setting_broadcast_pattern():
    from lasagne.utils import create_param
